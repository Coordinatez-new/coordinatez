...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "This page does not exist. Browse Coordinatez Global Trade capabilities, insights, and contact details, or return to the homepage.",
  path: "/404",
  noIndex: true,
});
    ...
    <section className="ink-panel relative flex min-h-[70vh] items-center overflow-hidden">
      ...
      <Container className="relative section-y">
        ...
        <div className="mt-9 flex flex-wrap gap-4">
          ...
          >
            <Link href="/#capabilities">Trade Capabilities</Link>
          </Button>
          <Button
            asChild
            size="lg"
