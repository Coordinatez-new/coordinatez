...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "How Coordinatez collects, uses, shares, and protects personal information on coordinatez.com — cookies and consent, Meta, Google, LinkedIn and Microsoft advertising and measurement tags, our AI assistant, form processing, retention, international transfers, and your GDPR, CCPA/CPRA and India DPDP rights.",
  path: "/privacy-policy",
  noIndex: false,
});
        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-8 text-pretty text-lg leading-relaxed text-muted-foreground">
              ...
              shares, and protects personal information when you visit coordinatez.com (the
              &ldquo;Site&rdquo;), submit a form, chat with our AI assistant, or contact us
              through it. It also sets out the disclosures required by the advertising and
              measurement platforms we may use — including Meta, Google, LinkedIn, and Microsoft
              — and the rights you have under the GDPR and UK GDPR, the California Consumer
            ...
            <PolicySection id="controller" title="1. Who we are">
              <p>
                ...
                policy. We are an IT services and AI solutions company with our global
                headquarters at {hq.addressLines.join(", ")}, a technology and development center
                in {siteConfig.locations.development.city},{" "}
                {siteConfig.locations.development.country}, and an office in{" "}
                {siteConfig.locations.australia.city}, {siteConfig.locations.australia.country}.
              </p>
              <p>
              ...
              <p>
                Our Global Trade division operates a separate website at{" "}
                <Ext href={siteConfig.tradeSite.url}>{siteConfig.tradeSite.name}</Ext>, which
                publishes its own privacy policy. This policy covers coordinatez.com only.
              </p>
            </PolicySection>
            ...
            <PolicySection id="what-we-collect" title="2. Information we collect">
              ...
              <PolicyList
                items={[
                  "Contact form: your name, email address, phone number, company, inquiry type, country, your message, and the page or referrer that brought you to the form.",
                  "Careers form: your name, email address, phone number, the position you are applying for, a link to your resume or portfolio, and any message you add. Please send only what a hiring review needs — not documents containing sensitive personal data.",
                  "AI assistant: the messages you type into the chat widget, and the replies generated for you.",
              ...
              <PolicyList
                items={[
                  "Technical data our servers and security tooling receive with every request — IP address, browser and device type, operating system, referring URL, the pages you request, and timestamps. IP addresses are also used to rate-limit form and chat submissions, and are held only transiently for that purpose.",
              ...
              <p>
                ...
                passwords. Please do not submit them through our forms or the AI assistant.
              </p>
            </PolicySection>
            ...
            >
              <PolicyList
                items={[
                  "To respond to your inquiries and provide information about our technology and AI services — performance of a contract or steps taken at your request, and our legitimate interest in answering business enquiries.",
                  "To evaluate career applications and contact you about current or future opportunities — steps taken at your request prior to an employment relationship, and our legitimate interest in recruiting.",
                  ...
                  "To comply with legal obligations and to establish, exercise, or defend legal claims — legal obligation and legitimate interest.",
                ]}
              />
              <p>
            ...
            <PolicySection id="ai-assistant" title="6. The Coordinatez AI assistant">
              <p>
                The chat widget on the Site is powered by Google&apos;s Gemini API. When you send
                a message, it travels to our server and is forwarded to Google together with a
                fixed instruction set describing our services, so a reply can be generated and
                streamed back to you. We do not store chat transcripts in a database: messages
                live in your browser tab for the session and pass through our server only while
                the reply is being produced. Your IP address is used, briefly and in memory only,
                to rate-limit abuse of the endpoint.
              </p>
              <p>
                Google processes these messages under its own API terms. Depending on the service
                tier in use, Google may retain conversations for a period and use them to improve
                its models and services.{" "}
                <strong className="text-foreground">
                  Please do not enter confidential information, personal data about other people,
                  credentials, or anything you would not want processed by a third party into the
                  assistant.
                </strong>{" "}
                For anything sensitive, email us at {mailTo} instead.
              </p>
              <p>
                The assistant produces machine-generated text and can be wrong. Nothing it says is
                a binding quote, contract, or professional advice. See{" "}
                <Ext href="https://policies.google.com/privacy">Google&apos;s Privacy Policy</Ext>{" "}
                for how Google handles the data it receives.
              </p>
            </PolicySection>

            <PolicySection id="forms" title="7. How form submissions are handled">
              <p>
                ...
                processor. Notification and confirmation emails are sent through our email
                provider.
              </p>
              <p>
                ...
                items={[
                  {
                    ...
                    detail: "Receives, stores, and forwards contact and careers form submissions.",
                  },
                  {
            ...
            <PolicySection id="embedded" title="8. Embedded maps and third-party links">
              <p>
                Our contact and location pages embed Google Maps. When such a map loads, Google
                receives your IP address and may set cookies under{" "}
                <Ext href="https://policies.google.com/privacy">Google&apos;s Privacy Policy</Ext>.
                The Site also links to external websites we do not operate — including our social
                profiles — and we are not responsible for their privacy practices. Review their
                policies before sharing information with them.
              </p>
            </PolicySection>

            <PolicySection id="recipients" title="9. Who we share information with">
              <p>
                ...
                and measurement platforms you have consented to, and where the law requires it —
                for example to respond to a lawful request, to enforce our terms, or in connection
                with a merger or acquisition, in which case this policy continues to apply until
              ...
              <DetailCards
                items={[
                  ...
                  },
                  {
                    ...
                    detail:
                      "Gemini API for the AI assistant, embedded Maps, and — with consent — Analytics, Ads, and Tag Manager.",
                  },
                  {
            ...
            <PolicySection id="retention" title="10. How long we keep information">
              <PolicyList
                items={[
                  "Contact enquiries: up to 24 months after our last exchange with you, so we can pick the conversation back up, then deleted or anonymized.",
                  "Career applications: up to 12 months after the decision, so we can consider you for future roles, unless you ask us to delete them sooner.",
                  "AI assistant conversations: not stored by us. They exist in your browser tab for the session and pass through our server transiently; Google retains what it receives under its own terms.",
            ...
            <PolicySection id="transfers" title="11. International data transfers">
              <p>
                ...
                (Mehsana, Gujarat), with an office in Australia. Information you submit may be
                accessed and processed by our teams in any of those countries, and by the
                providers listed in section 9 — most of which are established in the United
                States.
              </p>
              <p>
            ...
            <PolicySection id="your-rights" title="13. Your rights">
              ...
              <PolicyList
                items={[
                  ...
                  "Raise a grievance with us first — write to the address in section 17 and we will respond within the statutory timeframe. You may then escalate to the Data Protection Board of India.",
                ]}
              />
              <p>
            ...
            <PolicySection id="data-deletion" title="14. How to request deletion of your data">
              <p>
                ...
                normally within 30 days. We keep only what we are legally required to retain, and
